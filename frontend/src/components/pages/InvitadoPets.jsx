...
function InvitadoPets() {
    ...
    function Ejemplo() {
        ...
        const filteredItems = useMemo(() => {
            // Filtrar directamente por el estado "En Adopción"
            let filteredMascotas = mascotas.filter(mascota => mascota.estado === "En Adopcion" || mascota.estado === "Urgente"  );
            ...
            // Aplicar el filtro por estado solo si no es "todos" (aunque ya estamos filtrando por "En Adopcion")
        ...
        }, [mascotas, filterValue, statusFilter, hasSearchFilter]);
